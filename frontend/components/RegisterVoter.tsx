...
const RegisterVoter = ({
  ...
  return (
    <>
      {updateSuccessful || (userValidIdMethodExists && userImageExists) ? (
        <div className="mt-2 flex flex-col items-center justify-center p-6">
          ...
          <p className="text-2xl font-semibold text-center">
            You verification process was submitted and is now pending
            verification
          </p>
        ...
        <div className="mt-2 flex flex-col gap-2">
          ...
          {errMsg && (
            <p className="mt-2 text-lg text-red-500 font-semibold">{errMsg}</p>
          )}
          ...
          <div className="space-y-2">
            <div className="flex flex-col">
              <label className="font-semibold text-xl">Upload Valid ID</label>
              <FileBase64
                type="file"
                multiple={false}
                onDone={({ base64 }: { base64: string }) =>
                  setUserValidIdMethod(base64)
                }
              />
            </div>
            {userValidIdMethod && (
          ...
          <div className="space-y-2">
            <div className="flex flex-col">
              <label className="font-semibold text-xl">Photo of yourself</label>
              <FileBase64
                type="file"
                multiple={false}
                onDone={({ base64 }: { base64: string }) =>
          ...
          <button
            type="submit"
            className="bg-blue-600 hover:bg-blue-700 text-gray-50 font-bold py-2 px-4 rounded-lg w-72"
